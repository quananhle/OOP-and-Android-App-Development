...
import com.company.wizapp.databinding.FragmentSalesorderheadersCreateBinding;
...
public class SalesOrderHeadersCreateFragment extends InterfacedFragment<SalesOrderHeader> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(SalesOrderHeadersCreateFragment.class);
