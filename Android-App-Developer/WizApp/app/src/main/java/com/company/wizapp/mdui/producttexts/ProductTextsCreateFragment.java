package com.company.wizapp.mdui.producttexts;
...
import com.company.wizapp.databinding.FragmentProducttextsCreateBinding;
...
public class ProductTextsCreateFragment extends InterfacedFragment<ProductText> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ProductTextsCreateFragment.class);
