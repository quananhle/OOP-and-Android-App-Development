package com.company.wizapp.mdui.customers;
...
import com.company.wizapp.databinding.FragmentCustomersCreateBinding;
...
public class CustomersCreateFragment extends InterfacedFragment<Customer> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(CustomersCreateFragment.class);
