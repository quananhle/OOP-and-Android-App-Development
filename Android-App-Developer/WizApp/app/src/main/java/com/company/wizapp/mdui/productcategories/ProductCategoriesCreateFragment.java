...
import com.company.wizapp.databinding.FragmentProductcategoriesCreateBinding;
...
public class ProductCategoriesCreateFragment extends InterfacedFragment<ProductCategory> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(ProductCategoriesCreateFragment.class);
