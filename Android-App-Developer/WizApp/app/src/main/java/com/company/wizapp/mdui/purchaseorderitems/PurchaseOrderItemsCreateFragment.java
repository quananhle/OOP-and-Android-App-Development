...
import com.company.wizapp.databinding.FragmentPurchaseorderitemsCreateBinding;
...
public class PurchaseOrderItemsCreateFragment extends InterfacedFragment<PurchaseOrderItem> {
    ...
    private static final Logger LOGGER = LoggerFactory.getLogger(PurchaseOrderItemsCreateFragment.class);
