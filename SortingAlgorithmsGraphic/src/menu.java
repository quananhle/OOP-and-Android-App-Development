...
public class menu extends JFrame {
	...
	private JCheckBox iSort, mSort, qSort, hSort;
	...
	private String iText, mText, qText, hText;					//Experiment for getText() method of JTextArea
//=========================================================================================================================================//
...
//=========================================================================================================================================//
	...
	private void display() {
		...
		// Setting checkboxes
		iSort.setMnemonic(KeyEvent.VK_C);
		...
		bottomPanel.add(iSort);
		bottomPanel.add(mSort);
		bottomPanel.add(qSort);
		bottomPanel.add(hSort);		
		bottomPanel.add(all);		
...
/* Visulization */
	public void createWindow() {
		...
		// textLabel.setPreferredSize(new Dimension(960, 650));
