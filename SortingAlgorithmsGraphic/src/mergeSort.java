...
public class mergeSort {
	...
	protected static ArrayList<Integer> mergeSort(ArrayList<Integer> A){
	...
	private static ArrayList<Integer> sort(ArrayList<Integer> A){
		...
		//Check if the size of the ArrayList 'A' is larger than 1 element ArrayList
		if (A.size() > 1) {
			//Find the middle point of the array list 'A'
			middle = A.size() / 2;
			//Run the for loop from index 0 to the middle
			for (int i = 0; i < middle; i++) {
				//Copy all the elements of ArrayList 'A' into a new ArrayList 'Left'
				Left.add(A.get(i));
			}
	...
	private static ArrayList<Integer> merge(ArrayList<Integer> A, ArrayList<Integer> Left, ArrayList<Integer> Right){
